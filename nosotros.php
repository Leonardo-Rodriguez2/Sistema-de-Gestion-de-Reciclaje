...
<head>
    ...
    <title>Nosotros | EcoCusco</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <!-- Chart JS para cargar los gráficos de data/estadisticas.php -->
    ...
    <style>
        ...
        @media (max-width: 900px) {
            .section-about, .charts-container { grid-template-columns: 1fr; }
...
<body>
    ...
    <section class="section-stats">
        <div class="container">
            ...
            <div class="charts-container">
                <div class="chart-box">
                    <h3 style="margin-top:0; color:var(--dark);">Eficiencia por Mes (Último Año)</h3>
                    <canvas id="chartMensual"></canvas>
                </div>
                <div class="chart-box">
                    <h3 style="margin-top:0; color:var(--dark);">Distribución del Material Retirado</h3>
    ...
    <footer style="text-align: center; padding: 40px; color: var(--text-gray); font-size: 14px; background: white; border-top: 1px solid #E5E7EB; border-bottom: 5px solid var(--primary);">
