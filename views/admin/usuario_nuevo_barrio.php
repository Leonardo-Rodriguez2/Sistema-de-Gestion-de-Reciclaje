<?php
// views/admin/usuario_nuevo_barrio.php
...
$title = "Registrar Encargado de Barrio - EcoCusco";
$header_title = "Nuevo Encargado de Barrio";
$header_subtitle = "Asigna un nuevo gerente para supervisar un vecindario completo.";
...
<div class="form-container">
    <form action="router.php" method="POST" class="premium-form">
        ...
        <div class="form-section">
            <h3><span class="icon">🏠</span> Detalles del Cargo</h3>
            <div class="form-grid">
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="direccion" placeholder="Ej. Oficina Central del Barrio">
                </div>
            </div>
        </div>

        <div class="form-actions">
            <a href="router.php?page=usuarios&rol_id=5" class="btn-cancel">Volver a la lista</a>
